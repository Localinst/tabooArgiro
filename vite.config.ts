  ...
  
    {
      ...
      closeBundle: async () => {
        ...
        const pagesWithSeo = [
          ...
          { path: 'tr', title: 'Taboo Oyunu Çevrimiçi: Ücretsiz Parti Oyunu', description: 'Taboo oyununu çevrimiçi oyna! Yasak kelimeleri söylemeden kelimeleri tahmin etmek için kartları olan eğlenceli masa oyunu. Partiler, arkadaşlar ve akşamlar için mükemmel. Çok sayıda Taboo kelimesi!' }
        ];
